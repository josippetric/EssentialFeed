...
//
//  Created by Josip Petric on 18.08.2023..
//
...
final class EssentialFeedCacheIntegrationTests: XCTestCase {
	...
	func test_valdateFeedCache_deletesFeedSavedInDistantPast() {
	...
	private func save(_ feed: [FeedImage], with sut: LocalFeedLoader, file: StaticString = #filePath, line: UInt = #line) {
		let exp = expectation(description: "Waiting to save completion")
	...
	private func validateCache(with loader: LocalFeedLoader, file: StaticString = #filePath, line: UInt = #line) {
		...
		let validationExp = expectation(description: "Waiting for validation completion")
