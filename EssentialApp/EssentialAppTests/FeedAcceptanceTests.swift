...
final class FeedAcceptanceTests: XCTestCase {
	...
	private func showCommentsForFirstImage() -> ListViewController {
		...
		// Because pushing the VC on the stack is done animated,
		// the VC won't instantly be shown on the stack.
		// By calling RunLoop.run we make sure that the stack is updated
